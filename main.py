...
def install_packages():
    ...
    try:
        ...
        print("⚠️ Fragment API не установлен, пробуем установить...")
        try:
            subprocess.check_call([sys.executable, "-m", "pip", "install", "fragment-api-lib"])
            print("✅ Fragment API установлен")
        except:
            print("⚠️ Fragment API не установился, отправка Stars/Premium будет недоступна")
